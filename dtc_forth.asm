...
macro NEXT {
    ...
    jmp rax   ; jump to location in rax
}
...
defcode "WORD!",5,0,STOREWORD
    pop     rax
    pop     rbx
    mov     word [rax], bx 
    NEXT

defcode "WORD@",5,0,FETCHWORD
    pop     rax
    xor     rbx, rbx
    mov     word  bx, [rax]
    push    rbx
...
defcode "DWORD!",6,0,STOREDWORD
    pop     rax
    pop     rbx
    mov     dword [rax], ebx 
    NEXT

defcode "DWORD@",6,0,FETCHDWORD
    pop     rax
    xor     rbx, rbx
    mov     dword  ebx, [rax]
    push    rbx
...
defword "WORD,",5,0,COMMAWORD
; ( w -- )
; HERE wORD! 2 CHARS ALLOT ;
        dq HERE,STOREWORD,LIT,2
        dq CHARS,ALLOT
        dq EXIT

defword "DWORD,",6,0,COMMADWORD
; ( w -- )
; HERE wORD! 2 CHARS ALLOT ;
        dq HERE,STOREDWORD,LIT,4
        dq CHARS,ALLOT
        dq EXIT
...
; Note that no EXIT is compiled
	...
	dq HERE,LIT,5,PLUS
	dq LIT,DOVAR,SWAP,MINUS
	dq LIT,0xE9,COMMABYTE
	dq COMMADWORD,LIT,3,CHARS,ALLOT
        ;dq LIT,DOVAR,COMMA
        dq LIT,0,COMMA
        dq EXIT
...
; R> LATEST @ >CFA >BODY ! ;
        ...
        ;dq LIT,DODOES,
	dq CURRENT,FETCH,FETCH,TCFA
	dq DUPF,LIT,0xE9,SWAP,STOREBYTE
	dq DUPF,LIT,5,PLUS
	dq LIT,DODOES,SWAP,MINUS
	dq SWAP,LIT,1,PLUS,STOREDWORD
        ;dq FSTORE
...
TO3:    dq CELLPLUS,STATE,FETCH,ZBRANCH,TO1
...
PTO3:   dq CELLPLUS,STATE,FETCH,ZBRANCH,PTO1
...
; VALUE
       ; dq CREATE,COMMA,DOES,FETCH
        dq PARSENAME,HEADERCOMMA
	dq HERE,LIT,5,PLUS
	dq LIT,DOCONST,SWAP,MINUS
	dq LIT,0xE9,COMMABYTE
	dq COMMADWORD,LIT,3,CHARS,ALLOT
        ;dq LIT,DOCONST,COMMA
	dq COMMA
        dq EXIT
...
defword "CODE",4,0,FCODE
       dq BLF,WORDF,COUNT
       dq HEADERCOMMA
       ;dq HERE,CELLPLUS,COMMA
       ;dq COMMA,LATEST,FETCH,HIDDEN
       dq CURRENT,FETCH,FETCH,HIDDEN
       ;dq RBRAC
       ;dq ALIGNF
       dq EXIT
